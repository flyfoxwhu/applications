...
public class Sample_AuthFailed1 implements Watcher {
    ...
    final static String SERVER_LIST = "domain1.distribute.zookeeper:2181";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            zkClient.create("/zk-distribute", "".getBytes(), acls, CreateMode.EPHEMERAL);
            ...
            zkClient_error.getData("/zk-distribute", true, null);
